...
var (
	...
	removeFiles      = flag.Bool("remove_files", true, "Delete files after archiving them")
...
func main() {
	...
	if *enableTar {
		...
		if *removeFiles {
			...
			fmt.Println("Metrics files are not removed because the removeFiles flag is disabled.")
		}
